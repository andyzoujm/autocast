...
class Options:
    ...
    def add_optim_options(self):
        ...
        self.parser.add_argument(
            "--clip", type=float, default=1.0, help="gradient clipping"
        )
    ...
    def add_eval_options(self):
        self.parser.add_argument(
            "--write_results", action="store_true", help="save results"
        )
        self.parser.add_argument(
    ...
    def add_forecaster_options(self):
        self.parser.add_argument(
            "--max_seq_len", type=int, default=128, help="max lookback days"
        )
        self.parser.add_argument("--finetune_encoder", type=int, default=0)
        self.parser.add_argument("--adjust_targets", type=int, default=0)
